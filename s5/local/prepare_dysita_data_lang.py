...
"""
Give in input a list of id speaker that wants to evaluate and database folder
...
data = pandas.read_csv('./local/wordToPhonemes.csv')
data = data.fillna('')
phonemes = Phonemes()
...
#speakerKeysValues.sort()
#root = Tk()
#app = Application(root, speakerKeysValues, listOfSpeaker)
#root.mainloop()
